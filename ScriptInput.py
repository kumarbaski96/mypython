...
def main():
         ...
         while True:
                 ...
                 if "Received Security Definition" in line and "SecurityType(167)=OPT" in line:
                          ...
                          outputLine = str(tokenNo) + "," + InstrumentString + ",Option," + lStrikePrice + "," + lOptionType[0] + ",1," + str(epochTimeForExpiry) + ",1,10,20,40," + str(multiplier    ) + "," + "\n"
                         ...
                         priceMonitorFile.write(outputLine)
                          ...
                          #TTIAFile
                          outputLine = "1," + InstrumentString + "," + InstrumentString + "," + exchange + "," + SecurityID + "," + str(multiplier) + "," + "262=" + InstrumentString + "|263=1|264    =0|265=1|266=Y|267=3|269=0|269=1|269=2|146=1|55=" + underlyingSymbol + "|48=" + SecurityID + "|207=" + exchange + "|," + "\n"
                          TTIAFile.write(outputLine)

                          #TTGatewayFile
                          outputLine = str(tokenNo) + "," + underlyingSymbol + "," + str(multiplier) + ",15=USD|207=" + exchange + "|100=" + exchange + "|1028=N|18=o 2|167=OPT|200=" + expiryDate[    0:4] + expiryDate[4:6] + "|201=" + PutOrCall + "|202=" + strikePrice + "|59=W|,," + "\n"
